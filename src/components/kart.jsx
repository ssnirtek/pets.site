...
function Cart() {
    return ( 
      <div>
  <h2 className="text-center text-white m-2" style={{backgroundColor: 'rgb(128, 83, 114)'}}>Найденные животные</h2>
  <div id="carouselExampleIndicators" className="carousel slide m-auto w-75 p-2" data-bs-ride="carousel" style={{minHeight: 400}}>
    ...
    <div className="carousel-inner text-center" style={{backgroundColor: 'rgb(207, 187, 201)'}}>
      <div className="carousel-item active">
        <img src={dog} className="d-block mx-auto" alt="Собака" style={{width: 900}} />
        <h2>Найдена собака</h2>
        <p>Собака рыжая, была утеряна в красногвардейчком районе</p>
      </div>
      <div className="carousel-item">
        <img src={mouse} className="d-block mx-auto" alt="Мышь" style={{width: 900}} />
        <h2>Найдена мышь</h2>
        <p>Мышь серая, была утеряна в центральном районе</p>
      </div>
      <div className="carousel-item">
        <img src={goril} className="d-block mx-auto" alt="Горилла" style={{width: 900}} />
